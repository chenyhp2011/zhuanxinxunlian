    ...
    with col2:
        ...
        # --- 反馈界面 ---
            ...
            if st.session_state.timed_out:
                ...
                # ==========================================================================
                #  核心修复：确保超时也被计为一次“题目完成”，更新计数器
                #  我们检查当前完成的题目数是否“落后于”当前题目索引，如果是，就补上。
                # ==========================================================================
                if st.session_state.session_problem_count <= st.session_state.current_problem_index:
                    st.session_state.session_problem_count += 1
